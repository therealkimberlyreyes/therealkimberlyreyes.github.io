...
author:
    name: "[Kimberly Mariana Reyes Hernandez](https://therealkimberlyreyes.github.io)"
...
> "En el ámbito de la estadística, la **mediana** (del latín *mediānus* 'del medio'^[1](https://es.wikipedia.org/wiki/Mediana_(estad%C3%ADstica)#cite_note-1)^​) representa el valor de la variable de posición central en un conjunto de datos ordenados."
...
Podemos saber cuál es la **frecuencia** (número de veces que aparece un elemento en una muestra) de cada número si dibujamos un **histograma** con la función `hist`, **aquel elemento co**

#####  {style="text-align: center; color: red;"}

```{ento breaks nos permite dividir en histograma en las partes que queramos}
